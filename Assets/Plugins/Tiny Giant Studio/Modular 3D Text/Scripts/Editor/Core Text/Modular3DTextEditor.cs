    ...
    public class Modular3DTextEditor : Editor
    {
        ...
        private void MainSettings()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(showMainSettingsInEditor.faded))
            {
                ...
                {
                    //if (myTarget.autoFontSize && (myTarget.GetComponent<LinearLayoutGroup>()||myTarget.GetComponent<GridLayoutGroup>()))
                    if (myTarget.autoFontSize && (myTarget.GetComponent<LinearLayoutGroup>()))
                    {
                    }
                    else
                    {
                ...
                //if (myTarget.GetComponent<LinearLayoutGroup>())
                {
                    ...
                    if (myTarget.autoFontSize)
                    {
                        ...
                        if (myTarget.GetComponent<LinearLayoutGroup>())
                            MText_Editor_Methods.ItalicHorizontalField(maxWidth, "Max width taken by this", "" + variableName + "maxWidth", FieldSize.gigantic);
                        GUILayout.Space(10);
                    }
                }
        ...
        private void FindProperties()
        {
            ...
            maxWidth = soTarget.FindProperty("maxWidth");
