...
namespace TinyGiantStudio.Layout
{
    ...
    public class LinearLayoutGroup : LayoutGroup
    {
        ...
        /// <param name="meshLayouts"></param>
        /// <returns></returns>
        public List<MeshLayout> GetPositions(List<MeshLayout> meshLayouts, out float totalSpaceTaken)
        {
            totalSpaceTaken = 0;
        ...
        private MeshLayout SetMeshPosition(ref float x, ref float y, Bounds bound, MeshLayout meshLayout, float modifiedSpacing)
        {
            float toAddX = 0;
            float toAddY = 0;
        ...
        private void GetStartingPosition(ref float x, ref float y, Bounds[] bounds, float currentSpacing)
        {
            switch (alignment)
            {
                case Alignment.Top:
